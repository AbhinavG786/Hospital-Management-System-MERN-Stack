...
function AdminDoctor() {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          "http://localhost:5173/doctor/get-doctors"
        );
  ...
  const handleAddDoctor = async (e) => {
    e.preventDefault();
    await axios.post("http://localhost:5173/doctor/add-doctor",{
        name:docname,
  ...
  const editPatient = async (id) => {
    await axios
      .put(`http://localhost:5173/doctor/update-doctor/${id}`, {})
      .then((res) => {
        Swal.fire({
          title: "Success",
          icon: "success",
  ...
  const deletePatient = async (id) => {
    await axios
      .delete(`http://localhost:5173/doctor/delete-doctor/${id}`,)
      .then((res) => {
        Swal.fire({
          title: "Success",
          icon: "success",
